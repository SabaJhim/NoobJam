...
def howToPlay():
    ...
    lines = ["->->->Rules are similar classic Snake & Ladders game, agaist computer.", "You will start from token on "
                                                                                   "'tiles-1' and with 3 lives. You will "
                                                                                   "then roll a dice. ",
             "If the number is even, computer will take a turn. Instead of moving token, ","it will either move the "
                                                                                           "snake or the ladder by "
                                                                                           "that number.",
             "if the number is odd, your token will move forward by that number.","If you move to the tiles with a "
                                                                                   "snake's mouth, token will come "
                                                                                   "down to the","tiles with snake's "
                                                                                                 "tail, and lose a "
                                                                                                 "life.",
    "tiles with its top."]
    global crossFlux
